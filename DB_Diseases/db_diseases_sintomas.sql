...
--
-- Host: localhost    Database: db_diseases
-- ------------------------------------------------------
...
CREATE TABLE `sintomas` (
  ...
  KEY `fk_sintoma_enfermedad` (`Enfermedad_id`),
...
INSERT INTO `sintomas` VALUES (1,1,'Dolor de cabeza','Vision borrosa','Lagrimeo');
...
-- Dump completed on 2021-09-25 13:15:05
